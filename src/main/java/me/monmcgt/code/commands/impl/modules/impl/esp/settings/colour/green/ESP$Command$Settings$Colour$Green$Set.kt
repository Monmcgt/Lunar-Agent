...
object `ESP$Command$Settings$Colour$Green$Set` : CommandAbstract() {
    override fun execute() {
        ...
        `ESP$Command$Settings$Colour`.green = value
        printModuleSettingsValueMessage("ESP", "Colour (G)", value.toString())
    }
}