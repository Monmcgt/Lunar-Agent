...
public class RenderUtilsOld {
    ...
    public static void drawTracerLine(double x, double y, double z, int red, int green, int blue, float alpha, float lineWidth) {
        drawTracerLine(x, y, z, red / 255F, green / 255F, blue / 255F, alpha, lineWidth);
    }
    ...
    public static void drawTracerLine(double x, double y, double z, float red, float green, float blue, float alpha, float lineWidth) {
        ...
        GL11.glColor4f(red, green, blue, alpha);
        GL11.glBegin(2);
        // getEyeHeight = bridge$getEyeHeight
//        GL11.glVertex3d(0.0D, 0.0D + Minecraft.getMinecraft().thePlayer.getEyeHeight(), 0.0D);
        GL11.glVertex3d(0.0D, 0.0D + Minecraft.getPlayerBridge().getEyeHeight(), 0.0D);
